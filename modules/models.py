...
from .patch_convnet import build_pc_model
    ...
    def backbone(x_in):
        ...
        if backbone_type == 'ResNet50':
            ...
            return MobileNetV2(input_shape=x_in.shape[1:], include_top=False,
                               weights=weights)(x_in)
        elif backbone_type == "ConvNeXtSmall":
            return convnext.ConvNeXtSmall(input_shape=x_in.shape[1:], include_top=False,
            include_preprocessing=False, pooling="max")(x_in)
        elif backbone_type == "Patch-ConvNeXt":
            return build_pc_model(input_shape=x_in.shape[1:])(x_in)
        else:
